...
function main() {
  ...
  function preload() {
    var assets = {
      spritesheet: {
        birdie: ["images/bryan.png?1525843532228", 100, 50],
        clouds: ["images/clouds.png?1525843532069", 128, 64],
      },
      image: {
        finger: ["images/finger.png?1525843532604"],
        fence: ["images/fence.png?1525843532486"],
      } /*,
        audio: {
  ...
  function update() {
    if (gameStarted) {
      ...
      if (gameOver) {
        if (birdie.scale.x < 2) {
          birdie.scale.setTo(birdie.scale.x * 1.1, birdie.scale.y * 1.1);
        }
